class AppConfig {
  static const String supabaseUrl = 'https://nzjsmetjjyowxhkojoxr.supabase.co';

  static const String supabaseAnonKey =
      'sb_publishable_jBeLV5DJjE-2Or69A3G88A_UaFLHvL5';

  static const String emailVerificationRedirect = 'xploremy://login-callback';
...
class Operator {
  ...
  bool get isRail => id == 'ktmb' || id == 'rapid-rail-kl';
}
...
class Operators {
  ...
  static const rapidBusKuantan = Operator(
    ...
    staticPath: '/gtfs-static/prasarana?category=rapid-bus-kuantan',
    realtimePath:
  ...
  static const myBasKangar = Operator(
    ...
    staticPath: '/gtfs-static/mybas-kangar',
    realtimePath: '/gtfs-realtime/vehicle-position/mybas-kangar',
  );
  ...
  static const myBasAlorSetar = Operator(
    ...
    staticPath: '/gtfs-static/mybas-alor-setar',
    realtimePath: '/gtfs-realtime/vehicle-position/mybas-alor-setar',
  );
  ...
  static const myBasKotaBharu = Operator(
    ...
    staticPath: '/gtfs-static/mybas-kota-bharu',
    realtimePath: '/gtfs-realtime/vehicle-position/mybas-kota-bharu',
  );
  ...
  static const myBasTerengganu = Operator(
    ...
    staticPath: '/gtfs-static/mybas-kuala-terengganu',
    realtimePath: '/gtfs-realtime/vehicle-position/mybas-kuala-terengganu',
  );
  ...
  static const myBasIpoh = Operator(
    ...
    staticPath: '/gtfs-static/mybas-ipoh',
    realtimePath: '/gtfs-realtime/vehicle-position/mybas-ipoh',
  );
  ...
  static const myBasSerembanA = Operator(
    ...
    staticPath: '/gtfs-static/mybas-seremban-a',
    realtimePath: '/gtfs-realtime/vehicle-position/mybas-seremban-a',
  );
  ...
  static const myBasSerembanB = Operator(
    ...
    staticPath: '/gtfs-static/mybas-seremban-b',
    realtimePath: '/gtfs-realtime/vehicle-position/mybas-seremban-b',
  );
  ...
  static const myBasMelaka = Operator(
    ...
    staticPath: '/gtfs-static/mybas-melaka',
    realtimePath: '/gtfs-realtime/vehicle-position/mybas-melaka',
  );
  ...
  static const myBasKuching = Operator(
    ...
    staticPath: '/gtfs-static/mybas-kuching',
    realtimePath: '/gtfs-realtime/vehicle-position/mybas-kuching',
  );
